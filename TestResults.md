...
5. Персонаж переместился на препятсвие
6. Прошел
...
Тесты с номером: 12, 18 не прошли.

| Атрибут качества               | Результат в % |
| ------------------------------ | ------------- |
| Функциональная полнота         | 94            |
| Функциональная корректность    | 94            |
| Временная характеристика       | 94            |
| Доступность                    | 1             |
